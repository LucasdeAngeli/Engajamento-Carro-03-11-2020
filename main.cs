...
class MainClass {
  public static void Main (string[] args) {
    ...
    while (continuar=="S"){
      ...
      while(!ok){
        try{
          ...
          Console.WriteLine("Erro de Construtores")
        }
        finally {
    ...
    if(listaCarros.Count==0){
      throw new System.ArgumentExeption("A lista não pode estar vazia!");
    }
    ...
    for(int i=0;i<listaCarros.Count;i++){
      ...
      Console.WriteLine("VALOR GASTO AO PERCORRER 1000 KM: R$ {0}", (1000/listaCarros[i].getConsumo())*4.89);    
    }
